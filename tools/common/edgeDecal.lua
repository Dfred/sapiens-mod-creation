...
edgeDecal.groupTypes = mj:indexed { 
    ...
    },
	{
        ...
        size = vec2(0.01, 0.001),
    },
	{
        key = "hair",
        textureLocations = {
            edgeDecal.textureLocations.hairA,
            --edgeDecal.textureLocations.hairB,
        },
        size = vec2(0.006, 0.0),
    },
	{
